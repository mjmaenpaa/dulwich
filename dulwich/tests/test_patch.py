...
class WriteCommitPatchTests(TestCase):
    ...
    def test_simple(self):
        ...
        c.tree = Tree().id
        write_commit_patch(f, c, b'CONTENTS', (1, 1), version=b'custom')
        f.seek(0)
        lines = f.readlines()
...
"""
    ...
    def test_extract_mercurial(self):
        ...
        expected_diff = b"""diff --git a/dulwich/tests/test_patch.py b/dulwich/tests/test_patch.py
...
"""
        text = b"""From dulwich-users-bounces+jelmer=samba.org@lists.launchpad.net Mon Nov 29 00:58:18 2010
